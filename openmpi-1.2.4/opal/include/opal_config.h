...
#define OMPI_THREADS_HAVE_DIFFERENT_PIDS 1
...
#define PACKAGE_STRING "Open MPI 1.2.4"
...
#define WRAPPER_EXTRA_LIBS "-libverbs -lrt  -ldl   -Wl,--export-dynamic -lnsl -lutil -lm -ldl "
